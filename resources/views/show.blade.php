      ...
      <div class="flex flex-1 px-4 py-6">
         ...
         <div class="w-full mx-4">
            ...
            <div class="text-gray-600 mt-3">
               ...
               adipisicing elit. Qui nam repellendus tempora voluptates nostrum expedita, quos saepe
               blanditiis iure,omnis excepturi, perspiciatis sapiente? Rem ratione iste quibusdam error quis non?
            </div>
            ...
            <div 
               ...
               <form action="#" class="space-y-4 px-4 py-6">
                  ...
                  <div class="flex items-center space-x-3">
                     <button type="button"
                     class="flex items-center justify-center w-1/2 h-11 text-sm font-semibold bg-blue text-white rounded-xl
                          border border-blue hover:bg-blue-hover transition duration-150 ease-in px-8 py-3">
                      Post Comment
                     </button>
                     <button type="button" 
                           class="flex items-center justify-center w-32 h-11 text-xs font-semibold rounded-xl border 
                  ...
                  <div class="space-y-2">
                     <div>
                       <label class="inline-flex items-center">
                         <input class="form-radio" type="radio" checked="" class="bg-gray-200 text-gray-600 border-none" name="radio-direct" value="1">
                         <span class="ml-2">Open</span>
                       </label>
                     </div>
                     <div>
                       <label class="inline-flex items-center">
                         <input class="form-radio" type="radio" checked="" class="bg-gray-200 text-purple border-none" name="radio-direct" value="1">
                         <span class="ml-2">Considering</span>
                       </label>
                     </div>
                     <div>
                       <label class="inline-flex items-center">
                         <input class="form-radio" type="radio" checked="" class="bg-gray-200 text-yellow border-none" name="radio-direct" value="1">
                         <span class="ml-2">In Progress</span>
                       </label>
                     </div>
                     <div>
                       <label class="inline-flex items-center">
                         <input class="form-radio" type="radio" checked="" class="bg-gray-200 text-green border-none" name="radio-direct" value="1">
                         <span class="ml-2">Implement</span>
                       </label>
                     </div>
                     <div>
                       <label class="inline-flex items-center">
                         <input class="form-radio" type="radio" checked="" class="bg-gray-200 text-red border-none" name="radio-direct" value="1">
   ...
   <div class="comments-container relative space-y-6 pt-4 ml-22 my-8 mt-1">
      ...
      <div class="is-admin comment-container relative bg-white rounded-xl flex mt-4">
         <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
               <h4 class="text-xl font-semibold">
                  <a href="#" class="hover:underline">status change to "UNDER CONSIDERING"</a>
               </h4>
               <div class="text-gray-600 mt-3 line-clamp-3">
                   Lorem ipsum dolor, sit amet consectetur
               </div>
      ...
      </div> {{-- end comment THREE container --}}
